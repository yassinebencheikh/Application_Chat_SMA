...
public class ProfesseurAgent extends Agent {
 ...
 // Put agent clean-up operations here
    protected void takeDown() {
        ...
        System.out.println("Professeur-agent "+getAID().getName()+" terminating.");
    }
